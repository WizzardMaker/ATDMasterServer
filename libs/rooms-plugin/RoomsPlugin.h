...
public:
	...
	/// \brief Removes a participant from the system based on their guid
	/// \param[in] guid The guid of the user
	/// \return true - when user was logged in and could be logged off\n false - when user was not in the current list of user
	bool LogoffRoomsParticipant(RakNetGUID guid, RakNet::RakString* userName);
