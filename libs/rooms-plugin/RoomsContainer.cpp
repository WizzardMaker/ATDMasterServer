...
//	destroyOnModeratorLeave=roomCreationParameters->networkedRoomCreationParameters.destroyOnModeratorLeave;
	...
	tableRow->cells[DefaultRoomColumns::TC_ROOM_PASSWORD]->Set(roomCreationParameters->networkedRoomCreationParameters.password.GetLength() == 0 ? "" : roomCreationParameters->networkedRoomCreationParameters.password.C_String());
